...
import {
  ...
  setFavorites,
  journeyRequest,
  journeyRequestSuccess
} from "../../action/actions";

import { JourneyDateTimePattern } from '../../util/Journey';

import { store, handleFavoritter, handleJourneys } from "../reducers";
...
describe('store', function () {
  ...
  describe('handleFavoritter', () => {
    ...
    it('should handle loading favoritter object', () => {
      const newState = handleFavoritter(undefined, setFavorites({ 654321: { name: 'Sinsen [T-bane]' } }));
    ...
    it('should handle loading favoritter object with favorites already existing', () => {
      ...
      const newState = handleFavoritter(state, setFavorites({
        654321: {
          ID: 654321,
          location: undefined,
          name: 'Sinsen [T-bane]'
  ...
  describe('handleJourneys', () => {
    ...
    it('should merge with existing state', () => {
      const startState = {
        34561232: {
          isFetching: true,
          timestamp: moment().add(-1, 'days').format(JourneyDateTimePattern)
        }
      };
