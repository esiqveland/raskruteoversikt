...
var _user$project$Types$SearchStopp = F3(
	function (a, b, c) {
		return {id: a, name: b, district: c};
	});
var _user$project$Types$MonitoredVehicleJourney = F2(
	function (a, b) {
		return {destinationName: a, publishedLineName: b};
	});
var _user$project$Types$RuterAvgang = F2(
	function (a, b) {
		return {monitoringRef: a, monitoredVehicleJourney: b};
	});
var _user$project$Types$Position = F2(
	function (a, b) {
		return {longitude: a, latitude: b};
	});
var _user$project$Types$RuterStopp = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, name: b, district: c, placeType: d, zone: e, avganger: f, position: g};
	});
var _user$project$Types$RuterStoppApi = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, name: b, district: c, placeType: d, x: e, y: f, zone: g, avganger: h};
	});
var _user$project$Types$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _user$project$Types$Route = function (a) {
	return {ctor: 'Route', _0: a};
};
var _user$project$Types$Favorites = {ctor: 'Favorites'};
var _user$project$Types$About = {ctor: 'About'};
var _user$project$Types$Home = {ctor: 'Home'};
var _user$project$Types$LoadStopFailed = function (a) {
	return {ctor: 'LoadStopFailed', _0: a};
};
var _user$project$Types$LoadStopSuccess = function (a) {
	return {ctor: 'LoadStopSuccess', _0: a};
};
var _user$project$Types$SearchFailed = function (a) {
	return {ctor: 'SearchFailed', _0: a};
};
var _user$project$Types$SearchSuccess = function (a) {
	return {ctor: 'SearchSuccess', _0: a};
};
var _user$project$Types$DoSearch = {ctor: 'DoSearch'};
var _user$project$Types$UpdateSearchText = function (a) {
...
var _user$project$Api$searchStop = function (searchStr) {
	...
	return A3(
		...
		_user$project$Types$SearchFailed,
		_user$project$Types$SearchSuccess,
		A2(_evancz$elm_http$Http$get, _user$project$Api$decodeRuteSearch, url));
};
var _user$project$Api$toRuterStopp = function (stopp) {
	return A7(
		_user$project$Types$RuterStopp,
		stopp.id,
		stopp.name,
		stopp.district,
		stopp.placeType,
		stopp.zone,
		stopp.avganger,
		A2(_user$project$Types$Position, stopp.x, stopp.y));
};
var _user$project$Api$monitoredVehicleJourneyDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Types$MonitoredVehicleJourney,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'DestinationName', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'PublishedLineName', _elm_lang$core$Json_Decode$string));
var _user$project$Api$ruterAvgangDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Types$RuterAvgang,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'MonitoringRef', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'MonitoredVehicleJourney', _user$project$Api$monitoredVehicleJourneyDecoder));
var _user$project$Api$RuterStoppApi = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, name: b, district: c, placeType: d, x: e, y: f, zone: g, avganger: h};
	});
var _user$project$Api$ruterStoppApiDecoder = A9(
	_elm_lang$core$Json_Decode$object8,
	_user$project$Api$RuterStoppApi,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ID', _elm_lang$core$Json_Decode$int),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'Name',
		...
		_elm_lang$core$Json_Decode$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Json_Decode$null(0)
				]))),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'Y',
...
var _user$project$Api$loadStopId = function (id) {
	...
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Types$LoadStopFailed,
		_user$project$Types$LoadStopSuccess,
		A2(_evancz$elm_http$Http$get, _user$project$Api$ruterStoppApiDecoder, url));
};

var _user$project$Components_Spinner$spinner = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('sk-fading-circle')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle1 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('<Spinner />')
				])),
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle2 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle3 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle4 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle5 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle6 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle7 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle8 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle9 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle10 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle11 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('sk-circle12 sk-circle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
...
var _user$project$State$logError = function (a) {
	return _elm_lang$core$Debug$log(
...
var _user$project$State$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							stops: A3(
								_elm_lang$core$Dict$insert,
								_p3.id,
								_user$project$Api$toRuterStopp(_p3),
								model.stops),
							isLoading: false
						}),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'DoSearch':
				var newPage = _user$project$Types$Search(model.search);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_1: _elm_lang$navigation$Navigation$newUrl(
						_user$project$Pages$toHash(newPage))
				};
			case 'SearchSuccess':
				return {
					ctor: '_Tuple2',
...
var _user$project$State$Model = F6(
	function (a, b, c, d, e, f) {
		return {page: a, search: b, results: c, isLoading: d, stops: e, error: f};
	});
var _user$project$State$init = function (result) {
	return A2(
		_user$project$State$urlUpdate,
		result,
		A6(
...
var _user$project$View$stopView = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('View stop')
			]));
};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(stopp.name)
							]))
					])),
				A2(
				_elm_lang$html$Html$td,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(stopp.district)
					]))
			]));
};
	...
	return (_elm_lang$core$Native_Utils.cmp(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Ser du etter?')
					])),
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('searchResults')
					]),
				A2(_elm_lang$core$List$map, _user$project$View$result, model.results))
			])) : A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$View$searchForm = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onSubmit(_user$project$Types$DoSearch)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('Jernbanetorget'),
						_elm_lang$html$Html_Events$onInput(_user$project$Types$UpdateSearchText),
						_elm_lang$html$Html_Attributes$value(model.search)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onSubmit(_user$project$Types$DoSearch),
						_elm_lang$html$Html_Events$onClick(_user$project$Types$DoSearch)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$View$navItemStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '33%'},
			{ctor: '_Tuple2', _0: 'listStyleType', _1: 'none'},
...
var _user$project$View$navigationItem = F2(
	function (href$, title) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[_user$project$View$navItemStyle]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$a,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View$navigationItem, '#home', 'SØK'),
						A2(_user$project$View$navigationItem, '#favorites', 'FAVORITTER'),
						A2(_user$project$View$navigationItem, '#about', 'OM')
					]))
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Rask Rute')
					])),
				_user$project$View$navBar(model)
			]));
};
...
var _user$project$View$viewRuterStop = function (ruterStopp) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(ruterStopp.name)
					])),
				_user$project$View$viewAvganger(ruterStopp)
			]));
};
var _user$project$View$viewPage = function (model) {
	...
	switch (_p1.ctor) {
		case 'Home':
			return _elm_lang$core$Native_List.fromArray(
				[
					_user$project$View$searchForm(model),
					_user$project$View$searchResults(model)
				]);
		case 'About':
			return _elm_lang$core$Native_List.fromArray(
				[
		...
		case 'Route':
			var _p2 = A2(_elm_lang$core$Dict$get, _p1._0, model.stops);
			if (_p2.ctor === 'Nothing') {
				var _p3 = model.isLoading;
				if (_p3 === true) {
					return _elm_lang$core$Native_List.fromArray(
						[_user$project$Components_Spinner$spinner]);
				} else {
					return _elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Fant ikke noe')
						]);
				}
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$viewRuterStop(_p2._0)
					]);
			}
		default:
			return _elm_lang$core$Native_List.fromArray(
...
var _user$project$View$init = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$headerBar(model),
				_user$project$View$app(model),
				_user$project$View$foot(model)
			]));
};
...
var _user$project$Main$main = {
	main: A2(
		...
		_elm_lang$navigation$Navigation$makeParser(_user$project$Pages$hashParser),
		{init: _user$project$State$init, view: _user$project$View$init, update: _user$project$State$update, urlUpdate: _user$project$State$urlUpdate, subscriptions: _user$project$State$subscriptions})
};
